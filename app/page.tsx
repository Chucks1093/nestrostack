...
const serviceCards = [
	...
	},
	{
		...
		desc: "Connect your tools so your business runs like a machine. No more manual handoffs.",
		delay: "d2" as const,
	},
	{
		icon: (
		...
		desc: "A pipeline that works while you sleep. End-to-end lead capture and follow-up automation.",
		delay: "d3" as const,
	},
	{
		icon: <path d='M22 3H2l8 9.46V19l4 2v-8.54L22 3z' />,
		title: "Sales Funnel Design",
		desc: "Map the journey from stranger to paying client then automate every step.",
		delay: undefined,
	},
	{
		icon: (
		...
		desc: "Consistent, strategic social media and campaigns without you living on your phone.",
		delay: "d2" as const,
	},
	{
		icon: (
		...
		desc: "Let clients book themselves. You just show up. Fully automated booking and onboarding.",
		delay: "d3" as const,
	},
];
...
const steps = [
	{
		num: "01",
		title: "Clarity Call",
		body: "We listen first. No pitching, no jargon. Just a real conversation where we map your current chaos and understand exactly what your business needs.",
		delay: "d1" as const,
	},
	{
		num: "02",
		title: "Systems Blueprint",
		body: "We design your custom automation stack built around your specific business, your tools, and your goals. Nothing generic. Everything intentional.",
		delay: "d2" as const,
	},
	{
		num: "03",
		title: "Build and Hand Over",
		body: "We build it, test it, and hand you a business that actually runs. Clarity, confidence, and a system that works without you babysitting it.",
		delay: "d3" as const,
	},
];
		...
		<>
				...
				<div className='grid grid-cols-2 min-h-screen max-lg:grid-cols-1 max-lg:min-h-[auto]'>
					<div className='flex flex-col justify-center pr-16 pl-10 pt-[10rem] pb-20 max-lg:px-10 max-lg:pt-32 max-lg:pb-12 max-sm:px-6 max-sm:pb-10'>
						<h1 className='font-display text-[clamp(2rem,4.5vw,3.8rem)] font-semibold leading-[1.1] mb-5 opacity-0 [animation:fadeUp_0.9s_ease_forwards_0.4s]'>
							...
							<em className='text-blue'>Chaos.</em> Start Running It on{" "}
							<em className='text-blue'>Systems.</em>
						</h1>
						<p className='text-[1rem] text-ink-muted leading-[1.88] mb-8 opacity-0 [animation:fadeUp_0.9s_ease_forwards_0.6s] max-sm:text-[0.93rem] max-sm:mb-6'>
							Nestro Stack helps coaches, entrepreneurs, and real estate
							agents replace overwhelming manual work with automated
							business workflows that generate leads and drive income.
						</p>
			...
			<Reveal className='bg-blue-bright text-center py-20 px-10 mt-8 rounded-[2rem] mx-8 max-md:mx-4 max-md:rounded-[1.2rem] max-md:py-14 max-md:px-6 max-sm:mx-3 relative'>
				...
				<div className='max-w-[760px] mx-auto'>
					...
					<h2 className='font-display text-[clamp(2rem,3.5vw,2.8rem)] font-semibold leading-[1.2] mb-6 text-white'>
						...
						<mark className='bg-white/30 italic text-white rounded-[4px] px-[6px] italic'>
							always
						</mark>{" "}
						depend on you being in the room.
					</h2>
					<p className='text-[0.98rem] text-white/85 leading-[1.85] mb-5'>
						We have seen it happen to the best people. Talented coaches,
						hardworking real estate agents, driven entrepreneurs held
						hostage by the very business they built.{" "}
						<strong className='text-white font-semibold'>
							The missing piece is never more effort. It is always a
							system.
						</strong>{" "}
				...
				<div className='max-w-[1120px] mx-auto'>
					<Reveal>
						...
						<h2 className='font-display text-[clamp(1.75rem,4.5vw,3.8rem)] font-semibold leading-[1.1] mb-5'>
							...
							<em className='text-blue'>to run without you</em> holding
							it together.
						</h2>
						<p className='text-[1rem] text-ink-muted max-w-[560px] leading-[1.88]'>
							From CRM setup to full automation stacks, we build systems
							that work while you focus on what only you can do.
						</p>
					</Reveal>
			...
			<Reveal className='grid grid-cols-2 border-t border-b border-line max-lg:grid-cols-1'>
				...
				<div className='bg-surface px-[4.5rem] py-20 flex flex-col justify-center max-lg:px-8 max-lg:py-12 max-sm:px-6 max-sm:py-10'>
					...
					<h2 className='font-display text-[clamp(1.75rem,4.5vw,3.8rem)] font-semibold leading-[1.1] mb-5'>
						The steps we take to find the{" "}
						<em className='text-blue'>right solution.</em>
					</h2>
					<p className='text-[1rem] text-ink-muted max-w-[560px] leading-[1.88] mb-0'>
						We made it simple on purpose. You have been overwhelmed long
						enough.
					</p>
				...
				<div className='max-w-[1120px] mx-auto'>
					...
					<Reveal>
						<h2 className='font-display text-[clamp(1.75rem,4.5vw,3.8rem)] font-semibold leading-[1.1] mb-5'>
							...
							<em className='text-blue'>foundation.</em>
							<br />
							Let us build it.
						</h2>
					</Reveal>
